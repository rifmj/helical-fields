...
The payoff for the artist is direct control over how a flow twists and how tightly it
organizes---qualities that ordinary curl-noise leaves fixed---at no run-time cost downstream.
\end{abstract}
